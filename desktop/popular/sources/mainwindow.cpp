...
{
    QMessageBox::about(this, tr("About Popular"), (tr("<p><b>Popular %1</b></p>"
...
#endif // WITH_CUPS
                                                      + tr("</ul>"
                               "<p>&copy; %1 Originull Software.</p><p>&copy; %2 The qpdfview developers</p>").arg("2022", "2012-2022")));
}
...
void MainWindow::setWindowTitleForCurrentTab()
{
    ...
    setWindowTitle(tabText + QLatin1String("Popular") + instanceText);
}
...
{
    return new QDBusInterface(serviceName(instanceName), QLatin1String("/MainWindow"), QLatin1String("org.originull.popular.MainWindow"), QDBusConnection::sessionBus());
}
