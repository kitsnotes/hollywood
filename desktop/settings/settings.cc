...
void SettingsWindow::showAll()
{
    ...
    auto wheight = m_homeHeight;
    auto animation = new QPropertyAnimation(this, "size");
    m_list->setSizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::Expanding);
    auto wheight2 = m_list->preferredSize();
...
void SettingsWindow::setupMenu()
{
    ...
    auto file = m_menuBar->addMenu(tr("&Settings"));
