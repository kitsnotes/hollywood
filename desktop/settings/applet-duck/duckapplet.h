...
class DuckApplet : public QObject, SettingsAppletInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID SettingsAppletInterfaceIID FILE "applet-duck.json")
    Q_INTERFACES(SettingsAppletInterface)
public:
    explicit DuckApplet(QObject *parent = nullptr);
    bool init();
