...
private:
    ...
    unsigned int m_homeWidth = 870;
    unsigned int m_homeHeight = 600;

    QHash<SettingsAppletInterface*,QAction*> m_appletActions;
    QActionGroup *m_appletActionGroup;
    SettingsAppletInterface *m_current = nullptr;
    QList<SettingsAppletInterface*> m_backList;
    QList<SettingsAppletInterface*> m_forwardList;
