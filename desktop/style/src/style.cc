...
static const qreal TabBarTab_Rounding = 2.25;
static const qreal SpinBox_Rounding = 3.0;
static const qreal LineEdit_Rounding = 3.0;
...
static const qreal GroupBox_Rounding = 3.0;
static const qreal SliderGroove_Rounding = 2.0;
static const qreal SliderHandle_Rounding = 0.0;

static const qreal CheckMark_WidthOfHeightScale = 0.6;
...
void HollywoodStyle::drawControl(ControlElement element,
  ...
  case CE_MenuBarItem: {
    ...
    // A quick hack to use CommonStyle to render icons
    if(!mbi->icon.isNull() && mbi->text.isNull())
