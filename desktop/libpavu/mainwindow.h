...
class LIBPAVU_EXPORT MainWindow : public QDialog, public Ui::MainWindow {
    Q_OBJECT
public:
    MainWindow();
    virtual ~MainWindow();
...
public:
    ...
    void setCanRenameDevices(bool rn) { m_canRenameDevices = rn; }
    bool canRenameDevices() { return m_canRenameDevices; }
    void setSinkWidgets(const std::map<uint32_t, SinkWidget *> &newSinkWidgets);

private:
    bool m_canRenameDevices;
