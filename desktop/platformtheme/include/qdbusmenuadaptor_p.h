#ifndef QDBUSMENUADAPTOR_P_H
#define QDBUSMENUADAPTOR_P_H
...
"  </interface>\n"
        "")
public:
    DBusMenuAdaptor(DBusPlatformMenu *topLevelMenu);
...
public Q_SLOTS: // METHODS
    ...
    QList<int> EventGroup(const DBusMenuEventList &events);
...
private:
    DBusPlatformMenu *m_topLevelMenu;
};

QT_END_NAMESPACE


#endif // QDBUSMENUADAPTOR_P_H
