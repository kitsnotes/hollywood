...
void WlrLayerSurfaceV1::setWindow(QWindow *window)
{
    ...
    if (d->initialized) {
        qDebug() << "Unable to change WlrLayerSurfaceV1::window after initialization";
        return;
    }
...
void WlrLayerSurfaceV1::setLayer(WlrLayerSurfaceV1::Layer layer)
{
    ...
    if (d->initialized && !d->setLayerEnabled) {
        qDebug() << "Unable to change WlrLayerSurfaceV1::layer after initialization";
        return;
    }
...
void WlrLayerSurfaceV1::setRole(const QString &role)
{
    ...
    if (d->initialized) {
        qDebug() << "Unable to change WlrLayerSurfaceV1::role after initialization";
        return;
    }
...
void WlrLayerSurfaceV1::initialize()
{
    ...
    if (!d->window) {
        qDebug() <<"Window not assigned to WlrLayerSurfaceV1, failed to initialize";
        return;
    }
