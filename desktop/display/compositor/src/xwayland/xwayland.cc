...
Q_LOGGING_CATEGORY(gLcXwayland, "compositor.x11")
Q_LOGGING_CATEGORY(gLcXwaylandTrace, "compositor.x11.trace")
...
Compositor *XWaylandManager::compositor() const
{
    return m_compositor;
}

void XWaylandManager::setCompositor(Compositor *compositor)
{
...
{
    static const char name[] = "Hollywood";
