...
public:
    ...
    Originull::Platform::VtHandler *vtHandler() { return m_vtHandler.data(); }
...
private:
    ...
    static QList<QPlatformScreen::Mode> modesForScreenStatic(QScreen *screen);
    static QPlatformScreen::Mode preferredModeForScreenStatic(QScreen *screen);
    ...
    QScopedPointer<Originull::Platform::VtHandler> m_vtHandler;
    QScopedPointer<Originull::Platform::LibInputManager> m_liHandler;
