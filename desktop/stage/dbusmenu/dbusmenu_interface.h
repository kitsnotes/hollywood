 ...
 * Command line was: qdbusxml2cpp -p dbusmenu_interface.h: ../menuserver/com.canonical.dbusmenu.xml
 * This is a locally maintained file
 */
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> Event(int id, const QString &eventId, const QDBusVariant &data, uint timestamp)
    {
        ...
        return asyncCallWithArgumentList(QStringLiteral("Event"), argumentList);
    }
...
namespace com {
  namespace canonical {
    using dbusmenu = ::DBusMenuInterface;
  }
}
#endif
